...
namespace Z80
{
    ...
    {
        public Instruction(int opcode, string mnemonic, int size, TYPE type, string description, string explanation)
        {
            Opcode = opcode;
            Mnemonic = mnemonic;
            Size = size;
    ...
    public class Instructions
    {
        ...
        public Instructions()
        {
            ...
            Z80MainInstructions = new Instruction[]
            {
                ...
                new Instruction(0x80, "add a,b", 1, TYPE.NONE, "Add accumulator to register B", "The content of the accumulator is added to the content of the B register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x81, "add a,c", 1, TYPE.NONE, "Add accumulator to register C", "The content of the accumulator is added to the content of the C register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x82, "add a,d", 1, TYPE.NONE, "Add accumulator to register D", "The content of the accumulator is added to the content of the D register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x83, "add a,e", 1, TYPE.NONE, "Add accumulator to register E", "The content of the accumulator is added to the content of the E register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x84, "add a,h", 1, TYPE.NONE, "Add accumulator to register H", "The content of the accumulator is added to the content of the H register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x85, "add a,l", 1, TYPE.NONE, "Add accumulator to register L", "The content of the accumulator is added to the content of the L register.\r\nThe result is placed in the accumulator."),
                new Instruction(0x86, "add a,(hl)", 1, TYPE.NONE, "Add accumulator to indirectly addressed memory location (HL)", "The content of the accumulator is added to the content of the memory location addressed by the HL register pair.\r\nThe result is stored in the accumulator."),
                new Instruction(0x87, "add a,a", 1, TYPE.NONE, "Add accumulator to register A", "The content of the accumulator is added to the content of the A register.\r\nThe result is placed in the accumulator."),
                ...
                new Instruction(0x90, "sub b", 1, TYPE.NONE, "Subtract register B from accumulator", "Register B is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x91, "sub c", 1, TYPE.NONE, "Subtract register C from accumulator", "Register C is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x92, "sub d", 1, TYPE.NONE, "Subtract register D from accumulator", "Register D is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x93, "sub e", 1, TYPE.NONE, "Subtract register E from accumulator", "Register E is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x94, "sub h", 1, TYPE.NONE, "Subtract register H from accumulator", "Register H is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x95, "sub l", 1, TYPE.NONE, "Subtract register L from accumulator", "Register L is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x96, "sub (hl)", 1, TYPE.NONE, "Subtract the memory location specified by HL from accumulator", "The memory location specified by HL is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x97, "sub a", 1, TYPE.NONE, "Subtract accumulator from accumulator", "Register A is subtracted from the accumulator and the result is stored in the accumulator."),
                ...
                new Instruction(0xce, "adc a,n", 2, TYPE.NONE, "Add n to accumulator with carry", "operand n and the carry flag from the status register are added to the accumulator.\r\nThe result is stored in the accumulator."),
                ...
                new Instruction(0xd6, "sub n", 2, TYPE.NONE, "Subtract n from accumulator", "N is subtracted from the accumulator and the result is stored in the accumulator."),
                ...
                new Instruction(0xc2, "call po,nn", 3, TYPE.CONDITIONALCALL, "Call subroutine on parity odd result", "If the result is parity odd, the content of the program counter is pushed onto the stack as described for the PUSH instructions.\r\nThen, the content of the memory location immediately following the opcode is loaded into the low order of the PC and the content of the second memory location after the the opcode is loaded into the high order half of the PC.\r\nThe next instruction fetched will be from this new address.\r\nIf the condition is not met, the address 'nn' is ignored and the following instruction is executed."),
            ...
            Z80IXInstructions = new Instruction[]
            {
                ...
                new Instruction(0xdd86, "add a,(ix+o)", 3, TYPE.NONE, "Add the indexed addressed memory location (IX + o) to the accumulator", "The content of the memory location addressed by the content of the IX register plus the immediate offset value is added to the content of the accumulator."),
                ...
                new Instruction(0xdd94, "sub ixh", 2, TYPE.NONE, "Subtract the high byte of register IX from accumulator", "The high order byte of register IX is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0xdd95, "sub ixl", 2, TYPE.NONE, "Subtract the low byte of register IX from accumulator", "The low order byte of register IX is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0xdd96, "sub (ix+o)", 3, TYPE.NONE, "Subtract the memory location specified by (IX + o) from accumulator", "The memory location specified by (IX + offset) is subtracted from the accumulator and the result is stored in the accumulator."),
                ...
                new Instruction(0xdd9c, "sbc ixh", 2, TYPE.NONE, "Subtract with borrow the high byte of register IX from accumulator", "The high order byte of register IX, summed with the content of the carry flag, is subtracted from the content of the accumulator, the result is placed in the accumulator."),
                new Instruction(0xdd9d, "sbx ixl", 2, TYPE.NONE, "Subtract with borrow the low byte of register IX from accumulator", "The low order byte of register IX, summed with the content of the carry flag, is subtracted from the content of the accumulator, the result is placed in the accumulator."),
            ...
            Z80IYInstructions = new Instruction[]
            {
                ...
                new Instruction(0xfd86, "add a,(iy+o)", 3, TYPE.NONE, "Add the indexed addressed memory location (IY + o) to the accumulator", "The content of the memory location addressed by the content of the IY register plus the immediate offset value is added to the content of the accumulator."),
                ...
                new Instruction(0xfd94, "sub iyh", 2, TYPE.NONE, "Subtract the high byte of register IY from accumulator", "The high order byte of register IY is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0xfd95, "sub iyl", 2, TYPE.NONE, "Subtract the low byte of register IY from accumulator", "The low order byte of register IY is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0xfd96, "sub (iy+o)", 3, TYPE.NONE, "Subtract the memory location specified by (IY + o) from accumulator", "The memory location specified by (IY + offset) is subtracted from the accumulator and the result is stored in the accumulator."),
                ...
                new Instruction(0xfd9c, "sbc iyh", 2, TYPE.NONE, "Subtract with borrow the high byte of register IY from accumulator", "The high order byte of register IY, summed with the content of the carry flag, is subtracted from the content of the accumulator, the result is placed in the accumulator."),
                new Instruction(0xfd9d, "sbx iyl", 2, TYPE.NONE, "Subtract with borrow the low byte of register IY from accumulator", "The low order byte of register IY, summed with the content of the carry flag, is subtracted from the content of the accumulator, the result is placed in the accumulator."),
