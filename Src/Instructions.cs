    ...
    public class Instructions
    {
        ...
        public Instructions()
        {
            ...
            Z80MainInstructions = new Instruction[]
            {
                ...
                new Instruction(0x90, "sub a,b", 1, TYPE.NONE, "Subtract register B from accumulator", "Register B is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x91, "sub a,c", 1, TYPE.NONE, "Subtract register C from accumulator", "Register C is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x92, "sub a,d", 1, TYPE.NONE, "Subtract register D from accumulator", "Register D is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x93, "sub a,e", 1, TYPE.NONE, "Subtract register E from accumulator", "Register E is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x94, "sub a,h", 1, TYPE.NONE, "Subtract register H from accumulator", "Register H is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x95, "sub a,l", 1, TYPE.NONE, "Subtract register L from accumulator", "Register L is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x96, "sub a,(hl)", 1, TYPE.NONE, "Subtract the memory location specified by HL from accumulator", "The memory location specified by HL is subtracted from the accumulator and the result is stored in the accumulator."),
                new Instruction(0x97, "sub a,a", 1, TYPE.NONE, "Subtract accumulator from accumulator", "Register A is subtracted from the accumulator and the result is stored in the accumulator."),
                ...
                new Instruction(0xc6, "add n", 2, TYPE.NONE, "Add accumulator to immediate data n", "The content of the accumulator is added to the content of the memory location immediately following the op code.\r\nThe result is stored in the accumulator."),
                ...
                new Instruction(0xd6, "sub a,n", 2, TYPE.NONE, "Subtract n from accumulator", "N is subtracted from the accumulator and the result is stored in the accumulator."),
            ...
            Z80IXInstructions = new Instruction[]
            {
                ...
                new Instruction(0xdd96, "sub a,(ix+o)", 3, TYPE.NONE, "Subtract the memory location specified by (IX + o) from accumulator", "The memory location specified by (IX + offset) is subtracted from the accumulator and the result is stored in the accumulator."),
            ...
            Z80IYInstructions = new Instruction[]
            {
                ...
                new Instruction(0xfd96, "sub a,(iy+o)", 3, TYPE.NONE, "Subtract the memory location specified by (IY + o) from accumulator", "The memory location specified by (IY + offset) is subtracted from the accumulator and the result is stored in the accumulator."),
