...
namespace Z80
{
    public partial class SevenSegment : UserControl
    {
        ...
        private void SevenSegment_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.FillPolygon((segmentsValue & 0x01) == 0x01 ? brushLight : brushDark, segmentsPoints[4]);
            e.Graphics.FillPolygon((segmentsValue & 0x02) == 0x02 ? brushLight : brushDark, segmentsPoints[6]);
            e.Graphics.FillPolygon((segmentsValue & 0x04) == 0x04 ? brushLight : brushDark, segmentsPoints[5]);
            e.Graphics.FillPolygon((segmentsValue & 0x08) == 0x08 ? brushLight : brushDark, segmentsPoints[0]);
            e.Graphics.FillPolygon((segmentsValue & 0x10) == 0x10 ? brushLight : brushDark, segmentsPoints[1]);
            e.Graphics.FillPolygon((segmentsValue & 0x20) == 0x20 ? brushLight : brushDark, segmentsPoints[2]);
            e.Graphics.FillPolygon((segmentsValue & 0x40) == 0x40 ? brushLight : brushDark, segmentsPoints[7]);
            e.Graphics.FillPolygon((segmentsValue & 0x80) == 0x80 ? brushLight : brushDark, segmentsPoints[3]);
        }
